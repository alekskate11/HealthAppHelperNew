...
import com.example.healthapphelper.databinding.AddParticipantsToChatBinding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                UsersAdapter adapter = new UsersAdapter(filteredUsers, AddParticipantsToGroup.this::createChat); // Обновляем адаптер
    ...
    private void loadUsers() {
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                UsersAdapter adapter = new UsersAdapter(users, AddParticipantsToGroup.this::createChat);
